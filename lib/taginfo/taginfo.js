...
const getOtherKeys = (data) => {
    if (data.matches_key != undefined) return [data.other_key]
    if (data.matches_keys != undefined) return data.other_keys
    return []
}

const getOtherValues = (data) => {
    if (data.matches_value != undefined) return [data.other_value]
    if (data.matches_values != undefined) return data.other_values
    return []
}
